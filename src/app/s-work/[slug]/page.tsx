...
import { addToCart } from "../../action/action"; // Import the addToCart function
...
export default async function ProductPage({ params }: ProductPagesProps) {
  ...
  // Return message if product is not found
  if (!product) {
    return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col justify-center gap-6">
          ...
          <button
            ...
            onClick={() => handleAddToCart(product)} // On click, add to cart
          >
            Add to Cart
          </button>
        </div>
